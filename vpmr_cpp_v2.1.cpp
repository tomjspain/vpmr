...
// [[Rcpp::export]]
Rcpp::NumericVector gjk_rec_CIndex_partition(CharacterVector ids,
                                         NumericVector obs,
                                         NumericVector pred,
                                         std::string type,
                                         int d,
  ...
  reps.attr("method")       = "gjk_rec_CIndex_partition";

  return reps;
}

// [[Rcpp::export]]
Rcpp::NumericVector gjk_rec_CIndex_overlap(CharacterVector ids,
                                           NumericVector obs,
                                           NumericVector pred,
                                           std::string type,
                                           int d,
  ...
  reps.attr("d_is_percent") = d_is_percent;
  reps.attr("method")       = "gjk_rec_CIndex_overlap";
...
// [[Rcpp::export]]
Rcpp::NumericVector gjk_rec_CIndex_overlap_sets(CharacterVector ids,
                                                          NumericVector obs,
                                                          NumericVector pred,
                                                          std::string type,
  ...
  reps.attr("method")       = "gjk_rec_CIndex_overlap_sets";
